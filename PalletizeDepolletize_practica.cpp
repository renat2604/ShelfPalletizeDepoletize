/*
время загрузки/выгрузки - 8 сек.
кол-во стеллажей - 6000.
пополнение каналов при условии - коробок типа T < 15 на стеллаже.
Длинна канала - 5000 мм - 8 мест хранения.
кол-во каналов - 10.
Ключи для вывода:
1 – movebox2channel – перемещение коробки из входной паллеты в канал,
2 – moveboxCh2Ch – перемещение мешающей коробки из выхода канала на вход некоторого канала,
3 - struct box.
Вид отчета о перемещении коробок:
"time,boxID,eventtype,stackID,channelID,palletID
23,345,2,18.12.8,6,286"

Вид отчета о обработке паллет:
